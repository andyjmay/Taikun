...
namespace Taikun.Demo.WPF.ViewModels {
  public class ViewModelLocator {
    public ViewModelLocator() {
      ...
      SimpleIoc.Default.Register<IDatabaseManager<SqlServerDatabase>>(() => new SqlServerDatabaseManager(Settings.Default.TaikunDatabase, createIfNotExists: true), true);
